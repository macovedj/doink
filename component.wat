(component
  ...
  (core module (;0;)
    ...
    (import "wasi_snapshot_preview1" "proc_exit" (func $proc_exit|wasi_snapshot_preview1 (;0;) (type $.rodata)))
    ...
    (func $debug.print__anon_1092 (;6;) (type $.rodata) (param i32)
    ...
    (func $Thread.Mutex.lock (;8;) (type $.rodata) (param i32)
      (local i32 i32 i32 i32 i32 i32)
      global.get $__stack_pointer
      local.set 1
      i32.const 16
    ...
    (func $io.getStdErr (;9;) (type $.rodata) (param i32)
      (local i32)
    ...
    (func $Thread.Mutex.unlock (;12;) (type $.rodata) (param i32)
      (local i32 i32 i32 i32 i32 i32)
      global.get $__stack_pointer
      local.set 1
      i32.const 16
    ...
    (func $os.exit (;13;) (type $.rodata) (param i32)
    ...
    (func $debug.assert (;14;) (type $.rodata) (param i32)
    ...
    (func $Thread.Mutex.SingleThreadedImpl.lock (;15;) (type $.rodata) (param i32)
      (local i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32)
      global.get $__stack_pointer
      local.set 1
      i32.const 16
    ...
    (func $Thread.Mutex.SingleThreadedImpl.unlock (;18;) (type $.rodata) (param i32)
    ...
    (func $debug.print__anon_2357 (;26;) (type $.rodata) (param i32)
      (local i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32)
      global.get $__stack_pointer
      local.set 1
      i32.const 32
    ...
    (func $debug.dumpCurrentStackTrace (;27;) (type $.rodata) (param i32)
  ...
  (type (;5;) (func (param "left" u32) (param "right" u32) (result u32)))
  (alias core export 2 "foo#add" (core func (;19;)))
  (func (;8;) (type 5) (canon lift (core func 19)))
  (component (;0;)
    (alias outer 1 5 (type (;0;)))
    (import "add" (func (;0;) (type 0)))
    (type (;1;) (func (param "left" u32) (param "right" u32) (result u32)))
